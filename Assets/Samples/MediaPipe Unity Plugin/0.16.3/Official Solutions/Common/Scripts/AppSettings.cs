...
namespace Mediapipe.Unity.Sample
{
  ...
  public class AppSettings : ScriptableObject
  {
    ...
    [SerializeField]
    private ImageSource.ResolutionStruct[] _defaultAvailableWebCamResolutions =
    ...
    [SerializeField]
    private ImageSource.ResolutionStruct[] _defaultAvailableStaticImageResolutions =
      new ImageSource.ResolutionStruct[]
      {
